        ...
        simulateServerLogin(username, password)
            .then(response => {
                if (response.success) {
                    ...
                    window.location.href = 'CVhome.html'; // Change 'homepage.html' to the URL you want to redirect to
                } else {
        ...
        return new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
                ...
                if (username === 'user' && password === 'password') {
                    ...
                    resolve({ success: false, message: 'Invalid username or password. register an account!.' });
                }
